  ...
  return (
    <div className="container py-8 md:py-12">
      <div className="text-center mb-8">
        ...
        <h1 className="text-3xl md:text-4xl font-bold tracking-tighter sm:text-5xl">Free JPG to PDF Converter</h1>
        ...
        <CardContent className="p-4 md:p-6 text-center">
          {files.length === 0 ? (
            <div className="border-2 border-dashed rounded-xl p-8 md:p-12 hover:border-primary transition-colors cursor-pointer" onClick={handleUploadClick}>
              ...
              <h3 className="mt-4 text-base md:text-lg font-semibold">Drag and drop your JPG images here</h3>
            ...
            <div className="text-left">
              ...
              {/* Thumbnail Grid */}
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 md:gap-4 mb-6 max-h-[400px] overflow-y-auto p-2 border rounded-lg bg-muted/20">
                {files.map((file, index) => (
                  <div key={index} className="relative group aspect-[3/4] rounded-lg overflow-hidden border bg-background shadow-sm">
                    <img
                    ...
                    <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                      <Button variant="destructive" size="icon" className="h-8 w-8 rounded-full" onClick={() => removeFile(index)}>
                        <X className="h-4 w-4" />
                      </Button>
                    </div>
                ...
                <div
                  className="aspect-[3/4] rounded-lg border-2 border-dashed border-muted-foreground/25 hover:border-primary/50 flex flex-col items-center justify-center cursor-pointer transition-colors bg-muted/10 hover:bg-muted/20"
              ...
              <div className="flex flex-col sm:flex-row justify-center items-center gap-4 mt-6">
                ...
                <Button variant="secondary" onClick={handleReset} disabled={isLoading} className="w-full sm:w-auto">Clear All</Button>
              </div>
            </div>
          )}
        </CardContent>
