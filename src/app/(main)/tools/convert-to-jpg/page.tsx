...
export default function ConvertToJpgPage() {
  ...
  const relatedTools = tools.filter(tool => ['/tools/convert-from-jpg', '/tools/compress-image'].includes(tool.path));
  ...
  return (
    <div className="container py-12">
      <div className="text-center mb-12">
        <Breadcrumb className="flex justify-center mb-4">
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem><BreadcrumbPage>Convert to JPG</BreadcrumbPage></BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
        <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl">Convert Images to JPG Online</h1>
        <p className="mt-2 text-muted-foreground md:text-lg max-w-2xl mx-auto">
          Easily transform your PNG, WEBP, GIF, or other image formats into high-quality JPG files. Use our AI to suggest the best quality settings for optimal results.
        </p>
      </div>
      ...
      <section className="mt-16 space-y-8">
        ...
        <Card>
          <CardContent className="p-6 md:p-8">
            <h2 className="text-2xl font-semibold mb-4">How to Convert Images to JPG</h2>
            <ol className="list-decimal list-inside space-y-4 text-muted-foreground">
              <li><span className="font-semibold text-foreground">Upload Your Images:</span> Drag and drop or select your image files (PNG, WEBP, GIF, etc.).</li>
              <li><span className="font-semibold text-foreground">Adjust Quality Settings:</span> Use the slider to set your desired JPG quality. For an optimal balance, you can toggle the "AI Quality Suggestion" to let our AI choose the best setting for you.</li>
              <li><span className="font-semibold text-foreground">Start Conversion:</span> Click the "Convert Image(s)" button to begin processing all your files.</li>
              <li><span className="font-semibold text-foreground">Download Your JPGs:</span> Once converted, your new JPG files will be ready. Download them individually or as a single ZIP archive for multiple files.</li>
            </ol>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-6 md:p-8">
            ...
            <ul className="space-y-4 text-muted-foreground">
              <li className="flex items-start"><CheckCircle className="h-5 w-5 text-primary mr-3 mt-1 flex-shrink-0" /><div><span className="font-semibold text-foreground">Wide Format Support:</span> Convert PNG, WEBP, GIF, BMP, and TIFF to JPG.</div></li>
              <li className="flex items-start"><CheckCircle className="h-5 w-5 text-primary mr-3 mt-1 flex-shrink-0" /><div><span className="font-semibold text-foreground">AI Quality Suggestion:</span> Let our AI intelligently recommend the best quality setting to balance size and clarity.</div></li>
              <li className="flex items-start"><CheckCircle className="h-5 w-5 text-primary mr-3 mt-1 flex-shrink-0" /><div><span className="font-semibold text-foreground">Manual Quality Control:</span> Fine-tune the compression level with a simple slider for full control.</div></li>
              <li className="flex items-start"><CheckCircle className="h-5 w-5 text-primary mr-3 mt-1 flex-shrink-0" /><div><span className="font-semibold text-foreground">Batch Processing:</span> Upload and convert multiple images at once, saving you time.</div></li>
            </ul>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-6 md:p-8">
            ...
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="item-1">
                <AccordionTrigger>Why should I convert my images to JPG?</AccordionTrigger>
                <AccordionContent>JPG is one of the most widely supported image formats, making it great for compatibility. It also offers excellent compression, which is ideal for reducing file sizes for web use, emails, and storage.</AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-2">
                <AccordionTrigger>What happens to the transparency in my PNG files?</AccordionTrigger>
                <AccordionContent>The JPG format does not support transparency. When you convert a PNG with a transparent background, the transparent areas will be filled with a solid white color in the final JPG image.</AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-3">
                <AccordionTrigger>How does the "AI Quality Suggestion" work?</AccordionTrigger>
                <AccordionContent>Our AI analyzes the content of your image (e.g., details, colors, text) and suggests a quality setting that provides good compression while preserving important visual details, giving you an optimal result automatically.</AccordionContent>
              </AccordionItem>
            </Accordion>
          </CardContent>
        </Card>
