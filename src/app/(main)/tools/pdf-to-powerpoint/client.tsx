...
export default function PdfToPowerPointClient() {
    ...
    const features = [
        { title: 'Live Preview', description: 'See exactly which pages you are converting with our high-quality preview.' },
        { title: 'Selective Conversion', description: 'Choose specific pages from your PDF to convert, rather than the whole document.' },
        { title: 'Browser-Based Security', description: 'Your files are processed directly in your browser and never uploaded to our servers for maximum privacy.' },
        { title: 'High-Fidelity Output', description: 'Preserves the layout and quality of your PDF slides in the PowerPoint format.' },
    ];

    const steps = [
        { title: 'Upload PDF', description: 'Click the upload area or drag and drop your PDF file to get started.' },
        { title: 'Select Pages', description: 'Preview your document and select the specific pages you want to convert to slides.' },
        { title: 'Convert & Download', description: 'Click "Download PowerPoint" to instantly generate and save your .pptx file.' },
    ];

    const faqs = [
        { question: 'Is it free to use?', answer: 'Yes, this PDF to PowerPoint converter is 100% free to use with no hidden fees.' },
        { question: 'Are my files secure?', answer: 'Absolutely. We process all files locally in your browser, so your sensitive documents never leave your device.' },
        { question: 'Can I select specific pages?', answer: 'Yes! After uploading, simply click on the pages you want to include or exclude from the final PowerPoint presentation.' },
    ];

    const relatedTools = ['Crop PDF', 'Merge PDF', 'Split PDF'].map(name => `/tools/${name.toLowerCase().replace(/ /g, '-')}`);
    ...
    return (
        <ToolPageLayout
            ...
            aboutTitle="About PDF to PowerPoint Converter"
            aboutDescription="Our PDF to PowerPoint converter is a powerful tool designed to transform your static PDF documents into editable PowerPoint presentations. Whether you need to repurpose a report, extract slides from a lecture, or simply make edits to a PDF presentation, this tool preserves your layout and formatting while giving you the flexibility of PowerPoint. It works entirely in your browser, ensuring your files remain private and secure."
        >
