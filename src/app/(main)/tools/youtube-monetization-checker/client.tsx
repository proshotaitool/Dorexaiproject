...
export default function YouTubeMonetizationCheckerClient() {
    ...
    const relatedTools = ['/tools/youtube-channel-id-finder', '/tools/youtube-earning-calculator', '/tools/youtube-tag-generator'];

    const features = [
        { title: 'Instant Check', description: 'Instantly verify if any YouTube channel is monetized.' },
        { title: 'Detailed Stats', description: 'View subscriber count, total views, video count, and creation date.' },
        { title: 'Monetization Eligibility', description: 'Understand why a channel might or might not be monetized.' },
        { title: 'Competitor Analysis', description: 'Gain insights into other channels in your niche.' },
    ];

    const steps = [
        { title: 'Enter URL', description: 'Paste a YouTube Video URL, Channel URL, or Handle.' },
        { title: 'Check Status', description: 'Click the "Check Status" button to analyze the channel.' },
        { title: 'View Results', description: 'See if the channel is monetized and view detailed statistics.' },
    ];

    const faqs = [
        { question: 'How accurate is this tool?', answer: 'Our tool analyzes public data directly from YouTube to determine monetization status with high accuracy.' },
        { question: 'Is this tool free?', answer: 'Yes, this tool is completely free to use.' },
        { question: 'Can I check any channel?', answer: 'Yes, as long as the channel is public, you can check its monetization status.' },
    ];
    ...
    return (
        <ToolPageLayout
            ...
            aboutTitle="About YouTube Monetization Checker"
            aboutDescription="The YouTube Monetization Checker is a powerful tool designed for creators and marketers to instantly verify if a YouTube channel is monetized. It analyzes public channel data to determine if ads are being served and if the channel is part of the YouTube Partner Program (YPP). Gain insights into potential revenue streams and competitor strategies with just a click."
        >
