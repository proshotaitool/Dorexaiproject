...
export default function ResizeImagePage() {
  ...
  const PreviewContent = () => {
    ...
    if (view === 'results' && activeImage.isResized && activeImage.resizedUrl && activeImage.originalUrl) {
      return (
        <ReactCompareSlider
    ...
    return (
        <>
            ...
            {Number(dimensions.width) > 0 && Number(dimensions.height) > 0 && view === 'settings' && (
                <div className='absolute bottom-2 right-2 bg-black/50 text-white px-2 py-1 rounded-md text-xs z-10'>
