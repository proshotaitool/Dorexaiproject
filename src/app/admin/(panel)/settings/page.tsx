...
export default function SettingsPage() {
  ...
  const { data: logs, isLoading: logsLoading } = useCollection<AuditLog>(logsCollection!);
        ...
        <TabsContent value="API Keys" className="pt-4">
          <Card>
            ...
            <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
               ...
               <Card>
                  <CardHeader className="flex flex-row items-center justify-between pb-2">
                      <CardTitle className="text-base font-semibold">Google AdSense</CardTitle>
                      <img src="https://www.google.com/adsense/favicon.ico" alt="Adsense" className="h-6 w-6"/>
                  </CardHeader>
                  <CardContent className="space-y-2">
                    <p className="text-sm text-muted-foreground">Manage monetization IDs.</p>
                    <Button variant="outline">Manage</Button>
                  </CardContent>
              </Card>
               <Card>
